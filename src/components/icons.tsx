...
const PATHS: Record<IconName, React.ReactNode> = {
  ...
  heart: (
    <path d="M12 20.5 4.6 13c-2-2-2-5.2 0-7.1 2-2 5.1-2 7 0l.4.4.4-.4c2-2 5.1-2 7 0 2 1.9 2 5.1 0 7.1L12 20.5Z" />
  ),
  folder: (
    <path d="M3.5 6.5A1.5 1.5 0 0 1 5 5h4.6l2 2.2H19a1.5 1.5 0 0 1 1.5 1.5V18a1.5 1.5 0 0 1-1.5 1.5H5A1.5 1.5 0 0 1 3.5 18Z" />
  ),
  checkCircle: (
    <>
  ...
  flame: (
    <path d="M12 2.5s-5 4.7-5 9.6a5 5 0 0 0 10 0c0-1.7-.9-2.9-1.7-3.9.2 1.6-.6 2.6-1.3 2.6-.9 0-1.3-.9-1-1.9.5-1.7-.2-4-2-6.4Z" />
  ),
  truck: (
    <>
  ...
  wrench: (
    <path d="M14.7 6.3a4 4 0 0 0-5.4 4.7L4 16.3l2.7 2.7 5.3-5.3a4 4 0 0 0 4.7-5.4l-2.6 2.6-2-2Z" />
  ),
  sunrise: (
    <>
      <path d="M4 18h16" />
