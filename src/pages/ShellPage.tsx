...
export default function ShellPage({ title, scope }: { title: string; scope: string }) {
  return (
    <div>
      ...
      <Banner kind="warn">
        This part of the platform is <b>not available yet</b>. Rather than show a screen that looks
        like it works, nothing has been built here. What this area will cover: {scope}
      </Banner>
    </div>
  );
}
