...
./tests/sql/run_verification.sh   # 27 SQL suites, 333 assertions, on a throwaway PostgreSQL 16
```
...
tests/
  ...
  sql/        run_verification.sh + 27 verify_*.sql suites (schema/RLS/RPC/triggers)
              — 333 named assertions + the 520-check authorization matrix
