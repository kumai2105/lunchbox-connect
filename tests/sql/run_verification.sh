...
fail=0
for suite in verify_fresh_deploy verify_golden_path verify_rls_cross_portal verify_menu_cutover verify_downstream_wiring verify_authorization_matrix verify_special_period; do
  echo
  echo "==================== $suite ===================="
