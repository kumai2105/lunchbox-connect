...
fail=0
for suite in verify_fresh_deploy verify_golden_path verify_rls_cross_portal verify_menu_cutover verify_downstream_wiring verify_authorization_matrix verify_special_period verify_class_staff verify_kitchen_demand verify_correction_order verify_publish_future verify_db_boundary verify_insert_returning verify_super_admin_onboarding verify_rotation_autoadvance verify_app_users_policy verify_read_grants verify_note_privacy_and_states verify_slot_resize_concurrency verify_publish_record_race verify_analytics_volume verify_meal_period_tags verify_lifecycle_security verify_operational_spine verify_spine_scenarios verify_operability_closure verify_kitchen_sees_the_site; do
  echo
  echo "==================== $suite ===================="
